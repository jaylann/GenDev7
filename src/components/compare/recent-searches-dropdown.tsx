// app/compare/components/RecentSearchesDropdown.tsx
 ...
 */
export const RecentSearchesDropdown: FC<RecentSearchesDropdownProps> = ({searches, onClear, className}) => {
            ...
            <DropdownMenu>
                <DropdownMenuTrigger asChild>
                    <Button
                        ...
                        size="icon"
                        className={cn("rounded-full size-10 text-slate-400 hover:text-indigo-300 hover:bg-slate-700/70", // Adjusted styling
                ...
                <DropdownMenuContent
                    ...
                    sideOffset={10}
                >
                    <DropdownMenuLabel className="text-slate-100 font-semibold px-3 py-2">Recent
                        Searches</DropdownMenuLabel>
                    <DropdownMenuSeparator className="bg-slate-700/80"/>
                    {searches.map((search) => (<DropdownMenuItem
                            key={search.id}
                        ...
                        >
                            <span className="truncate block" title={search.label}>{search.label}</span>
                        </DropdownMenuItem>))}
                    {searches.length > 0 && (<>
                            <DropdownMenuSeparator className="bg-slate-700/80"/>
                            <DropdownMenuItem
