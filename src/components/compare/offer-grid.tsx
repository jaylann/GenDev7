...
interface OfferGridProps {
    ...
    isLoading: boolean;
    viewMode: ViewMode;
    // sortOption: SortOptionKey; // Removed as OfferCard doesn't use it
...
export const OfferGrid: FC<OfferGridProps> = ({
    ...
    if (offers.length === 0 && hasSearchBeenPerformed) { // only return null if search was done. Otherwise initial placeholder takes precedence
        return null;
    }
