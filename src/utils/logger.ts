...
const LOG_STYLES: Record<LogLevel, LogStyles> = {
    info: { prefix: "🔵 INFO", style: "color: #0ea5e9; font-weight: bold;" },
    warn: { prefix: "🟠 WARNING", style: "color: #f59e0b; font-weight: bold;" },
    error: { prefix: "🔴 ERROR", style: "color: #ef4444; font-weight: bold;" },
    debug: { prefix: "🟣 DEBUG", style: "color: #8b5cf6; font-weight: bold;" },
};
